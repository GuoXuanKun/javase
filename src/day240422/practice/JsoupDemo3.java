...
//            Element nextLink = linkWithText.nextElementSibling();
//            // 打印 文本 并且含 地址
//            System.out.println("Link with text: " + linkWithText.text() + ", Next link: " + nextLink.text() + ", Next link URL: " + nextLink.attr("href"));
//        }
        ...
        for (Element linkWithText : linksWithText) {
            ...
            if (nextLink != null && "a".equals(nextLink.tagName()) && nextLink.text().contains("苹果")) {
                System.out.println("Link with text: " + linkWithText.text() + ", Next link :" + nextLink.text() + "' URL: " + nextLink.attr("href"));
            }
        }
